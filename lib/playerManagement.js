...
console.log("this.subRequests[0].team: "+this.subRequests[0].team);
			...
			var playerIndex=this.isPlayerBeingSubbed(KAGNameOfPlayerToSubIn);		//if player is subbing back in for themself, just delete the sub request
			if(playerIndex!=-1){
