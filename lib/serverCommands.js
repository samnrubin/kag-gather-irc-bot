var arrayObj = require('./playingArray.js');
module.exports = function(db, bot, config, links, send, logger, serversArray, channels) {
    ...
    var playingArray = {}//{blueTeam: "test", redTeam: "test2" };
...
logger.info("checking the value of playingarray: "+arrayObj.playingArray+" blueteam: "+arrayObj.playingArray.blueTeam);
    }
