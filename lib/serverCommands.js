...
/*
    ...
    function requestSub(data, serverI) {
        ...
        playerManagement.addSubRequest(data[1]);
        /*var subbed = data[1];
    ...
    function addSubVote(data, serverI){
        //input format SUBVOTE "+playerToSub +" "+ playerReqSub
        playerManagement.addSubVote(data[1],data[2]);
