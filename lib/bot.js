...
module.exports = function(db, bot, config, links, send, logger, playingArray) {
    var commands = [{
        command: "!add",
        fn: addHandler,
        adminOnly: false,
    ...
    function startMatch(to) {
        ...
        getTeams(function(blueTeam, redTeam) {
            ...
            teamString=teamString+"'"+blueTeam[blueTeam.length]+"'}; ";
            ...
            teamString=teamString+"'"+redTeam[redTeam.length]+"'}; ";
            send(playingServer, "string[] red=" + teamString + "getRules().set('redTeam',red);");
            
            sent(playingServer, "getRules().set_bool('teamsUpdated',true);");
