...
logger.info("msg[1]= "+msg[1]);
    ...
    function showConnectedServers(from, to){
        ...
        var connectedString="";
        /*for(var i=0;i<playerManagement.connectedArray.length;i++){
            connectedString = connectedString + playerManagement.connectedArray[i]
        }*/
        bot.say(from, "Server connection status is: "+playerManagement.connectedArray/*connectedString*/);
    }
