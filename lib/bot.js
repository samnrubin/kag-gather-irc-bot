...
module.exports = function(db, bot, config, links, send, logger, serverCommands) {
    var commands = [{
        command: "!add",
        fn: addHandler,
        adminOnly: false,
...
//            serverCommands.playingArray = playingArray;
//	logger.info("playing array: "+playingArray+" blue: "+playingArray.blueTeam);
//	logger.info("playing array: "+serverCommands.playingArray+" blue: "+serverCommands.playingArray.blueTeam);
	logger.info("playing array: "+arrayObject.playingArray+" blue: "+arrayObject.playingArray.blueTeam);
