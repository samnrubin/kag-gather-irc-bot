...
module.exports = function(db, bot, config, links, send, logger) {
    ...
    function showHelp(from) {
        bot.say(from, "In order to play you must be linked and authed. You can link using !link.  Follow this guide to set up an auth account: https://www.quakenet.org/help/q/how-to-register-an-account-with-q More on how to play gather: "+ guideLink);
    }
