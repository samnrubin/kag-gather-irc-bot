...
logger.info("temp link returnVal: "+returnVal);
                    if(!returnVal) bot.say(to, from + ": could not create temporary link, that KAG account is already linked to an irc account");
