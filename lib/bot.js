...
logger.info("Showing player list for "+from+" to "+to);
    ...
    function showHelp(from) {
        bot.say(from, "In order to play you must be authed and/or linked. Follow this guide to set up an auth account: https://www.quakenet.org/help/q/how-to-register-an-account-with-q .  You can link using !link <kagUsername>.  More on how to play gather: "+ guideLink);
