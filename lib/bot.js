...
*/
                ...
                (function(nick, i) {
                    setTimeout(function(nick, i) {
                        if(serversArray[playerManagement.playingServer].password){
                            bot.say(nick, "you can join the game using http://furai.pl/joingame/"+serversArray[playerManagement.playingServer].publicIp +"/"+serversArray[playerManagement.playingServer].port+"/"+serversArray[playerManagement.playingServer].password);
                        }else{
                            bot.say(nick, "you can join the game using http://furai.pl/joingame/"+serversArray[playerManagement.playingServer].publicIp +"/"+serversArray[playerManagement.playingServer].port );
                        }
                    }, 1000*i);
                })(nick,i);
                }
...
logger.info('playingarray: '+playerManagement.playingArray+'playingarray.blueTeam: '+playerManagement.playingArray.blueTeam+'playingarraylength: '+playerManagement.playingArray.length+'playingarray.blueteam.length: '+playerManagement.playingArray.blueTeam.length);
            ...
            if(serversArray[playerManagement.playingServer].password){
                bot.say(to, "Match started on server " + serversArray[playerManagement.playingServer].name + ": " + irc.colors.wrap(cyan,blueTeam) + "(Blue Team) VS " + irc.conors.wrap(light_red,redTeam) + " (Red Team)" /*+ " join with http://furai.pl/joingame/"+serversArray[playerManagement.playingServer].publicIp +"/"+serversArray[playerManagement.playingServer].port+"/"+serversArray[playerManagement.playingServer].password*/);
            }else{
                bot.say(to, "Match started on server " + serversArray[playerManagement.playingServer].name + ": " + irc.colors.wrap(cyan,blueTeam) + "(Blue Team) VS " + irc.conors.wrap(light_red,redTeam) + " (Red Team)" /*+ " join with http://furai.pl/joingame/"+serversArray[playerManagement.playingServer].publicIp +"/"+serversArray[playerManagement.playingServer].port*/ );
            }
        });
    }
